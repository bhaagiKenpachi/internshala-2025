...
let CelebrityController = class CelebrityController {
    ...
    findOne(id) {
        return this.celebService.findOne(+id);
    }
    findAll() {
...
__decorate([
    ...
    __metadata("design:paramtypes", [typeof (_b = typeof create_celebrity_dto_1.CreateCelebrityDto !== "undefined" && create_celebrity_dto_1.CreateCelebrityDto) === "function" ? _b : Object]),
...
exports.CelebrityController = CelebrityController = __decorate([
    (0, common_1.Controller)('celeb'),
    __metadata("design:paramtypes", [typeof (_a = typeof celebrity_service_1.CelebrityService !== "undefined" && celebrity_service_1.CelebrityService) === "function" ? _a : Object])
], CelebrityController);
...
//   }
// }
//# sourceMappingURL=celeb.controller.js.map